...
using SGQ.Services.Identity.API.Configuration;
...
namespace SGQ.Services.Identity.API.Data
{
    public class ConfigurationDbContextSeed
    {
        public async Task SeedAsync(ConfigurationDbContext context,IConfiguration configuration)
        {
            ...
            clientUrls.Add("ProblemasApi", configuration.GetValue<string>("ProblemasApiClient"));
            clientUrls.Add("WorkflowApi", configuration.GetValue<string>("WorkflowApiClient"));
