...
using SGQ.Services.Identity.API.Extensions;
using SGQ.Services.Identity.API.Models;
...
namespace SGQ.Services.Identity.API.Data
{
    ...
    public class ApplicationDbContextSeed
    {
        ...
        private IEnumerable<ApplicationUser> GetDefaultUser()
        {
            ...
            new ApplicationUser()
            {
                ...
                UserName = "arnaldo@gmail.com",
                ZipCode = "98052",
                State = "SP",
                Street = "Gamba, 221",
                SecurityNumber = "535",
                NormalizedEmail = "arnaldo@gmail.com",
                NormalizedUserName = "arnaldo@gmail.com",
                SecurityStamp = Guid.NewGuid().ToString("D"),
            };
